          ...
          <Col xs={12} md={6}>
            <div className="mt-5 mb-3">
              ...
              <h1 className="color-white">
                ...
                <span className="hover-effect ms-3">N</span>
                <span className="hover-effect">i</span>
                <span className="hover-effect">y</span>
        ...
        <Row className=" mt-3" data-aos="fade-up">
          <Col xs={12} md={6} className=" my-5">
            ...
            <div className=" d-flex social_links gap-3">
              <a href="https://www.linkedin.com/in/softdev-niyas">
                <span>
                  <ImLinkedin className="fontwhite fs-3 " />
                </span>
              </a>
              <a href="https://github.com/niyas-softdev">
                <span>
                  <AiOutlineGithub className="fontwhite fs-3 " />
                </span>
              </a>
              <a href="mailto:softdev.niyas@gmail.com">
                <span>
